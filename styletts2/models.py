...
from styletts2.Modules.discriminators import (
...
class StyleTTS2(pl.LightningModule):
    ...
    def __init__(
        self, config: dict | StyleTTS2Config, args, text_aligner, pitch_extractor, bert
    ):
        super().__init__()
        if not isinstance(config, StyleTTS2Config):
        ...
        self.bert_encoder = nn.Linear(bert.config.hidden_size, args.hidden_dim)
    ...
    def forward(self, *args, **kwargs):
        raise NotImplementedError(
            "Define your forward method or use training_step directly."
        )
    ...
    def configure_optimizers(self):
        # Example optimizer config — customize as needed
