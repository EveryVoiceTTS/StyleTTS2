...
def train(
    ...
    trainer = L.Trainer(
        ...
        log_every_n_steps=native_config.get("log_interval", 10),
        enable_progress_bar=True,
    )

    datamodule = StyleTTS2DataModule(native_config, load_for_everyvoice=True)
    model = StyleTTS2(native_config, mode=mode.value)
